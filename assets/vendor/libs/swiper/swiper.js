    ...
    return function() {
        ...
        const U = (e, t) => {
                ...
                s[d]("touchstart", e.onDocumentTouchStart, {
                    ...
                    passive: !0
                }), (a.preventClicks || a.preventClicksPropagation) && i[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", F, !0) : e[c]("observerUpdate", F, !0), i[d]("load", e.onLoad, {
                    capture: !0
                })
            },
        ...
        class te {
            constructor() {
                ...
                const o = this;
                o.__swiper__ = !0, o.support = z(), o.device = A({
                ...
                }()), I), o.eventsListeners = {}, o.eventsAnyListeners = [], o.modules = [...o.__modules__], t.modules && Array.isArray(t.modules) && o.modules.push(...t.modules);
                const d = {};
                o.modules.forEach((e => {
                    e({
                        params: t,
                ...
                const c = m({}, Z, d);
                return o.params = m({}, c, ee, t), o.originalParams = m({}, o.params), o.passedParams = m({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach((e => {
        ...
        const me = [function(e) {
            ...
            function L(e) {
                ...
                const A = b();
                s.scale = z || A, d = z || A, !e || 1 === d && z ? (u = 0, f = 0) : (L = m.slideEl.offsetWidth, I = m.slideEl.offsetHeight, l = y(m.slideEl).left + r.scrollX, o = y(m.slideEl).top + r.scrollY, c = l + L / 2 - i, p = o + I / 2 - n, g = m.imageEl.offsetWidth, w = m.imageEl.offsetHeight, E = g * s.scale, x = w * s.scale, T = Math.min(L / 2 - E / 2, 0), M = Math.min(I / 2 - x / 2, 0), C = -T, P = -M, u = c * s.scale, f = p * s.scale, u < T && (u = T), u > C && (u = C), f < M && (f = M), f > P && (f = P)), z && 1 === s.scale && (m.originX = 0, m.originY = 0), m.imageWrapEl.style.transitionDuration = "300ms", m.imageWrapEl.style.transform = `translate3d(${u}px, ${f}px,0)`, m.imageEl.style.transitionDuration = "300ms", m.imageEl.style.transform = `translate3d(0,0,0) scale(${s.scale})`
            }
            ...
            function $() {
                ...
                t.wrapperEl.addEventListener("pointerdown", x, s), t.wrapperEl.addEventListener("pointermove", T, a), ["pointerup", "pointercancel", "pointerout"].forEach((e => {
            ...
            function k() {
                ...
                t.wrapperEl.removeEventListener("pointerdown", x, s), t.wrapperEl.removeEventListener("pointermove", T, a), ["pointerup", "pointercancel", "pointerout"].forEach((e => {
            ...
            a("beforeInit", (() => {
                ...
                t.params.a11y.enabled && (() => {
                    ...
                    p = C(p), u = C(u), p && p.forEach((t => g(t, r, e.nextSlideMessage))), u && u.forEach((t => g(t, r, e.prevSlideMessage))), f() && C(t.pagination.el).forEach((e => {
                        e.addEventListener("keydown", m)
                    })), t.el.addEventListener("focus", y, !0), t.el.addEventListener("pointerdown", v, !0), t.el.addEventListener("pointerup", w, !0)
                })()
                ...
                t.params.a11y.enabled && function() {
                    ...
                    h() && t.pagination.bullets.forEach((s => {
                        t.params.pagination.clickable && (n(s), t.params.pagination.renderBullet || (o(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, x(s) + 1)))), s.matches(ae(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                    }))
                }()
            })), a("destroy", (() => {
                t.params.a11y.enabled && function() {
                    ...
                    e = C(e), s = C(s), e && e.forEach((e => e.removeEventListener("keydown", m))), s && s.forEach((e => e.removeEventListener("keydown", m))), f() && C(t.pagination.el).forEach((e => {
                        e.removeEventListener("keydown", m)
                    })), t.el.removeEventListener("focus", y, !0), t.el.removeEventListener("pointerdown", v, !0), t.el.removeEventListener("pointerup", w, !0)
                }()
            }))
        }, function(e) {
            let {
